...
<body>
    ...
    <div class="contact-breadcrumb" style="background-color: rgba(0, 0, 0, 0.4);">
        <div class="heading d-flex align-items-center justify-content-start"
            ...
            <div class="container">
                <h1 class="text-light" style="font-size: 40px; font-weight: 700; color: #FFF;">About Us</h1>
            </div>
        </div>
        <div class="contact-breadcrumb py-3" style="background-color: rgba(0, 0, 0, 0.4);">
            <div class="container">
                <p class="m-0 text-light"><a href="index.php" class="text-light">Home</a> > About Us</p>
            </div>
        </div>
    </div>
